...
let CompanyService = class CompanyService {
    ...
    getCompanyById(id) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/getCompanyById`, { id });
    }
    getVerificationRequest(employer) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/getVerificationRequests`, { employer });
    }
    getEmployees(employer) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/getEmployees`, { employer });
    }
    getVerifiedUsers(employer) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/getVerifiedUsers`, { employer });
    }
};
...
let ConnectionsService = class ConnectionsService {
    ...
    makeConnection(userId, connectionId, name, employer, position, bio, senderName, senderEmployer, senderPosition, senderBio) {
        let role = 'REGULAR';
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/connections/addConnection`, { userId, connectionId, name, employer, position, bio, senderName, senderEmployer, senderPosition, senderBio });
    }
    getMyConnection(userId) {
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/connections/getMyConnnections`, { userId });
    }
    getMyConnectionRequests(connectionId) {
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/connections/getConnnectionRequests`, { connectionId });
    }
    getMyConnectionRequestsApproved(connectionId) {
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/connections/getConnnectionRequestsApproved`, { connectionId });
    }
    acceptRequest(Id) {
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/connections/acceptRequest`, { Id });
    }
    removeConnection(Id) {
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/connections/removeConnection`, { Id });
    }
};
ConnectionsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let UserService = class UserService {
    ...
    verifyCompany(email) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/verify`, { email });
    }
    verifyUser(email) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/verify`, { email });
    }
    deleteCompany(email) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/delete`, { email });
    }
    deleteUser(email) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/delete`, { email });
    }
    ...
    registerCompany(name, email, password, confirmPassword) {
        let role = 'COMPANY';
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/register`, { name, email, password, confirmPassword, role });
    }
    getCurrentUser() {
        ...
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/getUser`, { id });
    }
    getUser(id) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/getUser`, { id });
    }
    updateUser(profileData) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/updateUser`, { profileData });
    }
};
...
let UsershiftsService = class UsershiftsService {
    constructor(http) {
        this.http = http;
    }
    addShift(userId, data) {
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/usershifts/addShift`, { userId, data });
    }
    getUserShift(userId) {
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/usershifts/getShift`, { userId });
    }
    removeConnection(userId, start, end) {
        console.log("inside");
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/usershifts/removeShift`, { userId, start, end });
    }
};
UsershiftsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let AdminComponent = class AdminComponent {
    constructor(http, userService, ref) {
        this.http = http;
...
let CompanyDetailsComponent = class CompanyDetailsComponent {
    constructor(route, companyService, connectionsService, userService) {
        this.route = route;
...
let CompanyEmployeeListComponent = class CompanyEmployeeListComponent {
...
CompanyEmployeeListComponent.ctorParameters = () => [
...
let ChildboxComponent = class ChildboxComponent {
...
ChildboxComponent.ctorParameters = () => [
...
let DatacontainerDirective = class DatacontainerDirective {
    constructor(viewContainerRef) {
        this.viewContainerRef = viewContainerRef;
    }
};
DatacontainerDirective.ctorParameters = () => [
...
let CommentsComponent = class CommentsComponent {
    ...
    replyComment(index) {
        ...
        const myFactory = this.resolver.resolveComponentFactory(_childbox_childbox_component__WEBPACK_IMPORTED_MODULE_2__["ChildboxComponent"]);
...
let CompanyHomeComponent = class CompanyHomeComponent {
    constructor(companyService, connectionsService, userService) {
        this.companyService = companyService;
        this.connectionsService = connectionsService;
        this.userService = userService;
        this.employeeList = [];
...
let CompanySchedulerComponent = class CompanySchedulerComponent {
    constructor(ref, router, route, modal, userShiftServices) {
        this.ref = ref;
        this.router = router;
        this.route = route;
        this.modal = modal;
...
CompanySchedulerComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
...
let ConnectionApprovedListComponent = class ConnectionApprovedListComponent {
...
ConnectionApprovedListComponent.ctorParameters = () => [
    { type: src_app_services__WEBPACK_IMPORTED_MODULE_2__["ConnectionsService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_3__["MatPaginator"], { static: true })
...
let ConnectionProfileComponent = class ConnectionProfileComponent {
    constructor(router, route, userService, companyService, connectionsService) {
        this.router = router;
        this.route = route;
        this.userService = userService;
        this.companyService = companyService;
...
ConnectionProfileComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: src_app_services__WEBPACK_IMPORTED_MODULE_3__["UserService"] },
...
let ConnectionRequestComponent = class ConnectionRequestComponent {
    constructor(connectionsService) {
        this.connectionsService = connectionsService;
    }
    ngOnInit() {
...
ConnectionRequestComponent.ctorParameters = () => [
    { type: src_app_services__WEBPACK_IMPORTED_MODULE_2__["ConnectionsService"] }
];
...
let UserConnnectionsComponent = class UserConnnectionsComponent {
    constructor(connectionsService) {
        this.connectionsService = connectionsService;
    }
    ngOnInit() {
...
UserConnnectionsComponent.ctorParameters = () => [
    { type: src_app_services__WEBPACK_IMPORTED_MODULE_2__["ConnectionsService"] }
];
...
let UserProfileComponent = class UserProfileComponent {
    constructor(userService, companyService, formBuilder) {
        this.userService = userService;
        this.companyService = companyService;
        this.formBuilder = formBuilder;
...
let UserShiftSchedulesComponent = class UserShiftSchedulesComponent {
    constructor(ref, modal, userShiftServices) {
        this.ref = ref;
        this.modal = modal;
        this.userShiftServices = userShiftServices;
        this.view = angular_calendar__WEBPACK_IMPORTED_MODULE_5__["CalendarView"].Month;
...
UserShiftSchedulesComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModal"] },
    { type: src_app_services__WEBPACK_IMPORTED_MODULE_6__["UsershiftsService"] }
];
